...
```{r, compare_menigococcal_using_insurance}
...
```{r, compare_menigococcal_using_different_dimensions}
...
```{r, compare_menigococcal_using_race/ethnicity}
...
```{r, compare_menigococcal_using_urbanicity}
