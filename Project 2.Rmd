...
- HPV Vaccination Coverage: Regional level coverage estimates and differences between in coverage between genders   
- HPV Vaccination Coverage: State level differences coverage estimates and differences in coverage between genders  
...
#to allow calculation of difference
